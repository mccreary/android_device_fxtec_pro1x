...
$(foreach f,$(wildcard $(LOCAL_PATH)/keychar/*.kcm),\
...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/aandroid.software.device_id_attestation.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/android.software.device_id_attestation.xml \
